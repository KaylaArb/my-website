            ...
            <div className={styles.about__container}>
                <div className={styles.bio}>
                    <div className={styles.decsription}>
                        <p>Residing in Vancouver BC, I am currently completing my bachelor’s in business administration while self-teaching web and back end development. My background in business and fashion design has tremendously helped in rounding out my skills professionally and in web development.</p>
